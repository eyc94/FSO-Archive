...
describe('favorite blog', () => {
    test('when list has no blogs, should equal null', () => {
        const result = list_helper.favoriteBlog(noBlogs)
    ...
    test('when list has more than one blog, equals the right author', () => {
...
describe('most blogs', () => {
    test('when list has no blogs, return null', () => {
        const result = list_helper.mostBlogs(noBlogs)
        expect(result).toBe(null)
    })
    ...
    test('when list has many blogs, return the right author', () => {
